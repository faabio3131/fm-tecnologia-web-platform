...
const pages = [
  ...
  },
  {
    ...
    expected: [
      ...
      "Um Core para conectar toda a operação.",
      "Da recepção à gestão, tudo no mesmo fluxo.",
      "A academia acompanha. O aluno evolui.",
      "Da avaliação à evolução, todo o treino no mesmo contexto.",
      "O treino considera a estrutura real da academia.",
      "Da reserva ao acesso, tudo conectado ao aluno.",
      "Operação e financeiro no mesmo contexto.",
      "IRON INTELLIGENCE",
      ...
      "Planos para acompanhar o crescimento da academia.",
      "269",
      "2.690",
      "Enterprise",
      "Sob consulta",
      ...
      "Conecte gestão, operação e experiência do aluno.",
      "Falar com a FM",
      "Ver planos",
      "ironfitcore.com.br",
