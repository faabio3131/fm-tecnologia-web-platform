...
export const products: readonly Product[] = [
  {
    ...
    shortDescription: "Informações funcionais serão publicadas após validação do dossiê do produto.",
  ...
  },
  {
    ...
    positioning: "Mais informações serão publicadas após validação do dossiê do produto.",
    cta: { specialist: true },
    featured: false,
