...
export const metadata = createMetadata("Contato", "Fale com a FM Tecnologia por e-mail ou WhatsApp.", "/contato");

export default function Page() {
  return (
    <ContentPage eyebrow="Contato" title="Vamos conversar." intro="Entre em contato por e-mail ou WhatsApp para conversar sobre os produtos da FM Tecnologia.">
      <section className="section">
        <div className="container form-shell">
          <article className="product-card">
            ...
            <p>WhatsApp: <a href={`https://wa.me/${siteConfig.whatsapp.number}`}>{siteConfig.whatsapp.label}</a></p>
            <div className="actions">
              <a className="button button--secondary" href={`https://wa.me/${siteConfig.whatsapp.number}`}>Conversar pelo WhatsApp <span aria-hidden="true">→</span></a>
